...
) : id_(id), userId_(userId), categoryId_(categoryId),
    pfcDetailedCategoryId_(std::move(pfcDetailedCategoryId)),
    amount_(amount), description_(description),
    transactionDate_(transactionDate), createdAt_(createdAt),
    plaidTransactionId_(std::move(plaidTransactionId)) {}
...
const std::optional<PfcDetailedCategoryId>& Transaction::getPfcDetailedCategoryId() const noexcept { return pfcDetailedCategoryId_; }
...
void Transaction::setPfcDetailedCategoryId(const std::optional<PfcDetailedCategoryId>& id) { pfcDetailedCategoryId_ = id; }
